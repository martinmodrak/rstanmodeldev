...
plot_sbc_params <- function(params, binwidth = 10, caption = NULL, plot_stat = "median", x_axis_trans = "identity", y_axis_trans = "identity") {
    ...
    print(params %>% ggplot(aes(x = order_within)) + geom_segment(aes(x = 0, y = ci_mean, xend = 100, yend = ci_mean), colour = "grey25") + 
    ...
    print(params %>% ggplot(aes_string(x = "true_value", y = plot_stat)) + geom_point(alpha = point_alpha) + geom_abline(slope = 1, 
